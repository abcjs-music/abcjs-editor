<template>
	<div>
		<p>Grace notes are represented by notes inside of curly braces. They are attached to a following note and printed small.</p>
		<pre>{{abcString}}</pre>
		<div id="help-grace-paper"></div>
